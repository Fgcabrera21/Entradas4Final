...
class TicketSale {
    ...
    public TicketSale(String username, String paymentMethod, String concertName, String sectionName, int row, int seat) {
...
public class ConcertApp {
    ...
    private void buyTicket() {
        ...
        if (selectedSection.isSeatAvailable(selectedRow - 1, selectedSeat - 1)) {
            ...
            TicketSale ticketSale = new TicketSale(username, paymentMethod, concertName, sectionName, selectedRow, selectedSeat);
